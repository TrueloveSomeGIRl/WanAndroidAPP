        ...
        if (e instanceof ApiException) {
            ...
            switch (httpException.code()) {
                ...
                case SERVICE_UNAVAILABLE:
                    ...
                    break;
                default:
                    ex.message = "请求网络错误";  //其它均视为网络错误
                    break;
            }
            return ex;
        } else if (e instanceof ServerException) {    //服务器返回的错误
            ServerException resultException = (ServerException) e;
            ex = new ApiException(resultException, resultException.code==-1001?ErrorType.NOT_LOGIN:ErrorType.ERROR);
            ex.message = resultException.message;
            return ex;
        } else if (e instanceof JsonParseException ||e instanceof JsonSyntaxException || e instanceof JSONException || e instanceof ParseException) {
            ...
            ex = new ApiException(e, ErrorType.UNKNOWN_ERROR);
